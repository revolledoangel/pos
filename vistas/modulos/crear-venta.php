        ...
        <div class="box box-success">
                          ...
                          <td style="width: 50%">
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input-lg" id="nuevoTotalVenta" name="nuevoTotalVenta" total="" placeholder="000.00" readonly required>
          ...
          <div class="box-footer">
            ...
            <div class="pull-right">
              ...
              <div class="checkbox">
                <label><input type="checkbox" value="1" checked name="impresion" disabled>Imprimir Ticket</label>
              </div>
